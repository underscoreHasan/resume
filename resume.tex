...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
    \textbf{Languages/Technologies}{: Python, C, C++, Java, JavaScript, TypeScript, React, SQL, Express.js, Node.js, Arduino}\\
    \textbf{Developer Tools}{: Git, Linux, Docker, Google Cloud Platform, Postman, Chakra UI, JUnit, Mocha, Chai, Grafana} \\
