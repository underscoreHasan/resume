    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Served Node.JS backend via \textbf{RESTful API} to React frontend, enabling dataset management, querying and plotting.}
          \resumeItemListEnd 
          \vspace{-13pt}
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Built \textbf{full-stack web app} to search for social media handles across \textbf{200+} networks.}
